...
return (
  <div className="min-h-screen bg-cyan-100 text-white flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            {posts.map((posts:{id: number,title:string,body:string })=> (
             ...
             <div key={posts.id}className="border rounded-lg shadow-md p-4 bg-gray-100 hover:bg-gray-200 transition-all">
